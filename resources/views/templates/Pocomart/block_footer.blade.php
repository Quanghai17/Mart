<div class="footer">		
							...
							<form id="mc-form" class="newsletter-form" data-toggle="validator">
								<div class="input-group">
									...
									<span class="input-group-append subscribe">
										<button class="btn btn-default" type="submit" aria-label="Đăng ký"
						...
						<div id="copyright" class="col-lg-6 col-md-6 col-12">
							<div class="wsp">
								...
								<span class="opacity1">
									Cung cấp bởi
									<a href=""
										rel="noopener" title="Sapo" target="_blank">Kenna</a>
								</span>
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-12 text-right d-none d-lg-block">
							<ul>
								...
								@foreach (sc_link_collection()['footer'] as $url)
									...
									<li>
										<a  {{ ($url['data']['target'] =='_blank')?'target=_blank':''  }}
	...
	<div class="bottom-nav-bar-mobile">
		<div class="inner-group container">
			<div class="itembar" onclick="location.href='index.html';">
				<div class="bar-menu">
					<div class="icon">
			...
			<div class="itembar" onclick="location.href='/news';">
				<div class="bar-menu">
					<div class="icon">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
			...
			<div class="itembar" >
				<div class="bar-menu">
					...
					<a href="{{ sc_route('wishlist') }}">Yêu thích</a>
				</div>
			</div>
	...
	<link rel="preload"
		href="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/wishlist-comparea123.js')}}" as="script">
	<script src="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/wishlist-comparea123.js')}}"
		type="text/javascript"></script>

	<script src="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/indexa123.js')}}"
		type="text/javascript"></script>

	<link rel="preload" href="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/maina123.js')}}"
		as="script">
	<script src="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/maina123.js')}}"
		type="text/javascript"></script>
	<link rel="preload" as="style"
		href="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/ajaxcart.scssa123.css')}}"
		type="text/css">
	<link rel="preload" as="script"
		href="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/api_bizweba123.js')}}"
		type="text/javascript">
	<link href="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/ajaxcart.scssa123.css')}}"
		rel="stylesheet" type="text/css" media="all" />
	<script src="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/api_bizweba123.js')}}"
		type="text/javascript"></script>
	...
	<link rel="preload" as='style' type="text/css"
		href="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/animate.scssa123.css')}}">
	<link href="{{ sc_file($sc_templateFile.'/bizweb.dktcdn.net/100/429/689/themes/869367/assets/animate.scssa123.css')}}"
		rel="stylesheet" type="text/css" media="all" />
	<script type='text/javascript'>
		...
		if (!document.getElementById(font)) {
			...
			font_link.href = '/cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css';
			font_link.media = 'all';
