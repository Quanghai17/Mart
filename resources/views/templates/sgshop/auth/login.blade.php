...
<main id="main" class="">
    ...
    <div class="account-container lightbox-inner">
                ...
                <div class="account-login-inner">
                    ...
                    <form class="woocommerce-form woocommerce-form-login login" action="{{ sc_route('postLogin') }}" method="post">            
                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                            <label for="username">Tên tài khoản hoặc địa chỉ email&nbsp;<span class="required">*</span></label>
                            <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="email" id="email" autocomplete="email" value="" />					</p>
                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                        ...
                        <p class="form-row">
                            ...
                            <input type="hidden" id="woocommerce-login-nonce" name="woocommerce-login-nonce" value="cf50e38207" /><input type="hidden" name="_wp_http_referer" value="/my-account/" />						<button type="submit" class="woocommerce-button button woocommerce-form-login__submit" name="login" value="Đăng nhập">Đăng nhập</button>
                        </p>
        ...
        <div class="col-12 col-sm-12">
            ...
            <form action="{{ sc_route('postLogin') }}" method="post" class="box">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <input class="woocommerce-Input woocommerce-Input--text input-text {{ ($errors->has('email'))?"input-error":"" }}"
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                    ...
                    <input class="woocommerce-Input woocommerce-Input--text input-text {{ ($errors->has('password'))?"input-error":"" }}"
