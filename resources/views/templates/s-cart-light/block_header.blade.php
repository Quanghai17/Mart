                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item"><a class="rd-nav-link" href="#"><i class="fa fa-lock"></i> {{ $url['data']['name'] }}</a>
                      <ul class="rd-menu rd-navbar-dropdown">
                        ...
                        <li class="rd-dropdown-item">
                          <a class="rd-nav-link" {{ ($item['data']['target'] =='_blank')?'target=_blank':''  }} href="{{ sc_url_render($item['data']['url']) }}">{{ sc_language_render($item['data']['name']) }}</a>
                        </li>
                        @endforeach
                      </ul>
                    </li>
                    ...
                    @if (sc_config('link_account', null, 1))
                      ...
                      @else
                        <li class="rd-nav-item"><a class="rd-nav-link" href="#"><i class="fa fa-lock"></i> {{ sc_route('login') }}</a>
                          <ul class="rd-menu rd-navbar-dropdown">
